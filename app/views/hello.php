            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading">FUNDACLIU</h1>
                        <p class="intro-text">Fundación Centrol Clínico Universitario Rómulo Gallegos FUNDACLIU</p>
                    ...
                    <div class="media">
                        <div class="icono Modulos">
                            <div class="media-left">
                                <a href="#">
                                    <img src="public/medical_histories/img/bb.png" height="100" width="100" >
                                </a>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="media">
                        <div class="icono Modulos">
                            ...
                            <div class="media-body justificar">
                                <h3 class="media-heading">Control Prenatal</h3>
                                <p>Control control kskakdafahf</p>
                                <button class="boton btn btn-default btn-lg">Accede</button>
                            </div>
                        </div>
                    </div>
