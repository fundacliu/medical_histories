...
CREATE TABLE medical_histories.personas (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, nombres varchar(50) NOT NULL , apellidos varchar(50) NOT NULL , nacimiento date NOT NULL , direccion varchar(128) NOT NULL , Lugar_nacimiento varchar(30) NOT NULL , registro date NOT NULL , id_sexo int UNSIGNED  NOT NULL);
